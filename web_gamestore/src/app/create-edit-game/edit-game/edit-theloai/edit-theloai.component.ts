...
@Component({
  selector: 'app-edit-theloai',
  templateUrl: './edit-theloai.component.html',
  styleUrls: ['./edit-theloai.component.scss']
})
export class EditTheloaiComponent implements OnInit {
