...
@Component({
  selector: 'app-create-image-logo',
  templateUrl: './create-image-logo.component.html',
  styleUrls: ['./create-image-logo.component.scss']
})
export class CreateImageLogoComponent implements OnInit {
